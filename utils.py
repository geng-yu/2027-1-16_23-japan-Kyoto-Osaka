...
def show_food_table(region):
    ...
    data_source = {
        "京都飯店-吃": [
            {"店名": "京都拉麵小路 (京都駅ビル10F)", "時間": "11:00-22:00", "備註": "8間拉麵"},
        ...
        "琵琶湖山谷": [
            {"店名": "Terrace Cafe Biwako Terrace", "時間": "09:00-17:00", "備註": "山頂站旁主餐廳，咖哩、漢堡排"},
            {"店名": "Cafe Stand at North Terrace", "時間": "10:00-16:00", "備註": "北Terrace外帶式，琵琶湖咖哩¥1,300"},
            {"店名": "Cafe 360 Biwako Valley", "時間": "10:00-15:30", "備註": "蓬萊山頂，最後點餐15:00"},
        ...
        "白鬚神社": [
            ...
            {"店名": "道の駅 藤樹の里あどがわ", "時間": "09:00-18:00", "備註": "農產直賣所、十割蕎麥美食街、炸雞丼、Lawson"},
        ],
        "浮御堂": [
        ...
        "天橋立": [
            {"店名": "Goods Stall Amanohashidate View Land", "時間": "09:00-18:00", "備註": "單軌售票機旁賣店，濃郁牛奶布丁¥450"},
        ...
        "新京極寺町": [
            ...
            {"店名": "名代とんかつ かつくら 三条本店", "時間": "11:00-20:30", "備註": "炸豬排、自己磨芝麻"},
