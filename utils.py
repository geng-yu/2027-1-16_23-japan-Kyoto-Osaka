...
def show_food_table(region):
    ...
    data_source = {
        ...
        "二條城鴨川": [
            {"店名": "茶房 前田 二条城", "時間": "09:30-16:00", "備註": "二条城境內庭園旁茶房，抹茶、刨冰、冰淇淋汽水，坐長椅看庭園"},
            {"店名": "スターバックス 京都三条大橋店", "時間": "08:00-23:00", "備註": "鴨川旁，河景座位、廁所，走河堤前後的休息點"},
            {"店名": "祇園辻利 四条祇園本店", "時間": "10:30-20:00", "備註": "四條大橋過橋5分，抹茶霜淇淋、抹茶漂浮，小孩會愛，2F有座位"},
        ],
        "環球城": [
