...
def show_food_table(region):
    ...
    data_source = {
        ...
        "京都飯店-逛": [
            {"店名": "京都アバンティ", "時間": "10:00-21:00", "備註": "京都AVANTI｜頂樓GU、百圓店、ABC Mart鞋"},
            {"店名": "ドン・キホーテ 京都アバンティ店", "時間": "24H", "備註": "唐吉訶德 AVANTI店"},
            {"店名": "GU 京都アバンティ店", "時間": "10:00-21:00", "備註": "GU AVANTI店｜頂樓"},
            {"店名": "イオンモールKYOTO", "時間": "10:00-21:00", "備註": "AEON MALL京都｜UNIQLO、MUJI、mont-bell"},
            {"店名": "DAISO イオンモールKYOTO店", "時間": "10:00-21:00", "備註": "大創 AEON京都店｜Kaede館4F半層樓"},
            ...
            {"店名": "京都ポルタ", "時間": "10:00-20:30", "備註": "京都Porta地下街｜220間店，3COINS、伴手禮"},
        ],
        "宇治": [
